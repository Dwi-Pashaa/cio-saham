...
@section('subtitle', 'Buat akun pengelola sistem dan tentukan level hak akses pengguna.')
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border bg-white">
            <div class="card-header border-bottom py-3 px-4 bg-white">
                <h3 class="card-title fw-bold text-dark mb-0">Formulir Data Pengguna</h3>
            </div>
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label required" for="role">Hak Akses / Level</label>
